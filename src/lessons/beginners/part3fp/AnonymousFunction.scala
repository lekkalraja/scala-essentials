package lessons.beginners.part3fp
...
object AnonymousFunction extends  App {
  ...
  println(justPrint)  // Prints definition  =>lessons.beginners.part3fp.AnonymousFunction$$$Lambda$22/0x00000001000c3840@43bd930a
